...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-surface flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-surface-card p-8 rounded-[32px] shadow-2xl shadow-slate-950/50 border border-slate-800 animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">Join BusMS for premium travel experiences</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              type="text"
              className="w-full px-5 py-4 bg-slate-900 border-none rounded-2xl focus:ring-2 focus:ring-primary/20 transition-all font-medium text-white"
