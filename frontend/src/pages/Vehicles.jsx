...
export default function Vehicles() {
  ...
  const columns = [
    ...
    { key: 'assigned_driver_name', label: 'Driver', render: v => v || <span className="text-slate-500">Unassigned</span> },
    {
    ...
    },
    {
      ...
      render: (_, row) => (
        <button
          ...
          className="text-slate-500 hover:text-primary-light transition-colors text-xs"
        >
          Edit
        </button>
      )
    ...
    <div className="space-y-5">
      <div className="page-header">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">{vehicles.length} buses registered</p>
        </div>
